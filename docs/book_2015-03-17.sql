...
# Database: book
# Generation Time: 2015-03-17 12:27:32 +0000
# ************************************************************
...
VALUES
	(44,'中国古代史','袁腾飞','湖南人民出版社','2014-01-01','123-456-789',15,1,100,1,'我们知道Linux这玩意儿是在计算机上面运作的，所以说Linux就是一组软件。问题是这个软件是操作系统还是应用程序？ 且Linux可以在哪些种类的计算机上面运作？而Linux源自哪里？为什么 Linux 还不用钱？这些我们都得来谈一谈先！','2015030219183954f4470f71e94.png',1425295119),
	(45,'中国近代史','袁腾飞','湖南人民出版社','2014-01-01','123-456-789',15,2,100,1,'我们知道Linux这玩意儿是在计算机上面运作的，所以说Linux就是一组软件。问题是这个软件是操作系统还是应用程序？ 且Linux可以在哪些种类的计算机上面运作？而Linux源自哪里？为什么 Linux 还不用钱？这些我们都得来谈一谈先！','2015030218595654f442acb5801.png',1425294005),
